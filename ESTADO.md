...
## 🔶 Isolamento multi-fazenda no WhatsApp — 24/08/2026 — **EM REVISÃO** (branch local)

Branch `fix/whatsapp-isolamento-fazenda`, 4 commits, **sem PR e sem push**. Apolo revisando.
