...
export default function CustosPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Custo por Talhão</h1>
        <p className="text-sm text-muted-foreground mt-1 font-medium">Custo das operações registradas por área</p>
      </div>
